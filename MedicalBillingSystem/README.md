...
## Project Description
The Medical Billing System is an assembly language program designed to manage transactions in a medical store. It allows users to buy medicines, view statistics, and calculate total earnings. This project demonstrates the use of assembly language for inventory and billing management.

---

## Features
- **Medicine Purchase**: Allows users to buy medicines and calculates the total cost.
- **Statistics**: Displays information about available medicines and their prices.
- **Earnings Calculation**: Tracks total earnings from sales.

---

## Inputs and Outputs
- **Input**: User's selection of medicines and quantities.
- **Output**: Total cost of purchased medicines and updated earnings.
...
- This project is a practical example of using assembly language for inventory and billing management.
